...
bool ReceiverController::start(int inputType, const QString &deviceId, int bleChannel)
{
    ...
    m_thread = std::make_unique<std::thread>(
        [session, channel, inputType, idStr, self]() {
            ...
            int result = backend_session_run_ble(session, channel, inputType,
                                                 idPtr, &rowTrampoline, self);
...
/* static */ void ReceiverController::rowTrampoline(const backend_ble_row_t *row,
                                                    void *user)
{
...
void ReceiverController::handleRow(const backend_ble_row_t *row)
{
    QVariantMap map;
